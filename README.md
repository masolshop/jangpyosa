...
- **최신 커밋**: `c50e321` - 월 근로시간 기준 통계 시스템 완료 ✅
  - **monthlyWorkHours 필드 추가**: Prisma 스키마에 월 근로시간 전용 필드 추가
  - **2026년 최저시급 기준**: 10,320원 (월 60시간 = 619,200원)
  - **월 근로시간 기준 급여**: 60~209시간 랜덤, 급여 = 월 근로시간 × 10,320원
  - **UI 표시 개선**: "근로시간 월 XX시간 | 월 XXX원 (시급 XXX원)"
  - **목업 직원 55명 재생성**: buyer01(15명), buyer03(12명), buyer05(13명), supplier01(15명)
