...
- **최종 배포 시간**: 2026-02-22 01:05 KST
- **최신 커밋**: `b69bdce` - 프로덕션 배포 완료 ✨
  - 표준사업장(SUPPLIER) 권한 확장 완료
  - 표준사업장에 buyerProfile 추가 (마이그레이션 완료)
  - BUYER, SUPPLIER, SUPER_ADMIN 모두 동일한 직원 관리 기능 사용
  - 초대받은 팀원(buyer0101 등)도 회사 데이터 정상 접근 가능
  - 장애인 직원 관리, 월별 부담금/장려금 관리, 출퇴근 관리 권한 통합
  - **✅ AWS 프로덕션 서버 배포 및 마이그레이션 완료**
