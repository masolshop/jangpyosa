...
- **최종 배포 시간**: 2026-02-22 01:00 KST
- **최신 커밋**: `c304c68` - 표준사업장 권한 확장 및 마이그레이션 완료 ✨
  - 표준사업장(SUPPLIER)도 장애인 직원 고용 및 관리 가능
  - 표준사업장 회원가입 시 buyerProfile 자동 생성
  - BUYER, SUPPLIER, SUPER_ADMIN 모두 동일한 직원 관리 기능 사용
  - 장애인 직원 관리, 월별 부담금/장려금 관리, 출퇴근 관리 권한 통합
  - 기존 표준사업장 계정 마이그레이션 스크립트 추가 (SQL + TypeScript)
  - **⚠️ 프로덕션 배포 시 마이그레이션 필수 실행** ✅
