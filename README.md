...
- **최종 배포 시간**: 2026-02-22 00:33 KST
- **최신 커밋**: `44db02b` - 팀원 권한 수정 완료 🔐
  - 초대받은 팀원이 회사 데이터에 접근할 수 있도록 수정
  - getUserCompany 헬퍼 함수 추가 (ownerUserId → user.companyId)
  - 장애인 직원 관리 API 권한 수정
  - 월별 고용장려금부담금 관리 API 권한 수정
  - 근태 관리 API 권한 수정
  - **팀원도 회사 소유자와 동일한 데이터 접근 가능** ✅
