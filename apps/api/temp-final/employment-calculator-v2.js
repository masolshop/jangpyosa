 ...
 */
export function calculateMonthlyData(employees, totalEmployeeCount, year, month, companyType = "BUYER") {
 ...
 * 연간 데이터 계산
 */
export function calculateYearlyData(employees, monthlyEmployeeCounts, year, companyType = "BUYER") {
    const results = [];
